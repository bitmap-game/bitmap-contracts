...
console.log(`Bridge Contract Proxy Addr: ${deployOutput.bitmapRentHelperContract}`)
...
async function main() {
    ...
    const BridgeFactory = await ethers.getContractFactory("BitmapRentHelperContract", owner);
    ...
    console.log('bitmapRentHelperContract deployed to:', bridge.target);
}
